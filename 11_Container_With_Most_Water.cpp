...
/*
 ...
 Set two integers as boundaries, and move them towards each other until they meet, and return the optimal solution among all results.
 
 Suppose height[i] < height[j], the result is determined by height[i], which has no relevance with height[j]. For this specific i, any move of j would decrease the result. Thus we skip all related cases by ++i.
